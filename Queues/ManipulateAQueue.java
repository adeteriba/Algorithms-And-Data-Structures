...
Problem Statement
Manipulate a queue according to the given insert and remove commands and then output the string that is at the front of the queue. 
If a remove command is issued for an empty queue then nothing should happen.

Input Format
A series of lines involving either INSERT or REMOVE commands. 
